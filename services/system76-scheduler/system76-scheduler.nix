...
let
  scheduler = pkgs.callPackage ../../pkgs/system76-scheduler { };
in
{
  options = {
  ...
  config =
    ...
    lib.mkIf cfg.enable {
      ...
      environment.etc = {
        ...
        "system76-scheduler/exceptions/default.ron".source =
          "${cfg.package}/etc/system76-scheduler/exceptions/default.ron";
